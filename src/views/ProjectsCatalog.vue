...
export default {
  ...
  async mounted() {
    ...
    try {
      ...
      console.log(this.filterProjets);
    } catch (error) {
  ...
  methods: {
    ...
    filterAlphabetically(projects) {
      if (this.order) {
        return projects.sort((a,b)=>a.initials.localeCompare(b.initials));
      } else {
         return projects.sort((a,b)=>b.initials.localeCompare(a.initials));
      }
    },
